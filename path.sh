export KALDI_ROOT=/home/sgeadmin/kaldi
...
sequitur=/home/beiping.shu/.local/bin/g2p.py
sequitur_path=/usr/lib/python2.7/site-packages
...
#kaldi_lm
KALDI_LM_ROOT=$KALDI_ROOT/tools/kaldi_lm
export PATH=$PATH:$KALDI_LM_ROOT
